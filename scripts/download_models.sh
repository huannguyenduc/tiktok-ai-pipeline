...
aria2c -x 16 -s 16 -d $COMFY_MODELS/unet -o hunyuan_video_720_cfgdistill_fp8_e4m3fn.safetensors https://huggingface.co/Kijai/HunyuanVideo_comfy/resolve/main/hunyuan_video_720_cfgdistill_fp8_e4m3fn.safetensors

# 3. FaceSwap (ReActor Model - inswapper_128)
echo "Tải FaceSwap Model (inswapper_128) để chốt khuôn mặt..."
aria2c -x 16 -s 16 -d $COMFY_MODELS/insightface -o inswapper_128.onnx https://huggingface.co/ezioruan/inswapper_128.onnx/resolve/main/inswapper_128.onnx
